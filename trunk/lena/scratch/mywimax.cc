...
int main (int argc, char *argv[])
{
  ...
  (ssNodes.Get(0) -> GetObject<ConstantVelocityMobilityModel>()) -> SetPosition(Vector(-1500.0, 0.0, 0.0)); 
  (ssNodes.Get(0) -> GetObject<ConstantVelocityMobilityModel>()) -> SetVelocity(Vector(80.0, 0.0, 0.0));

  mobility.SetMobilityModel ("ns3::ConstantPositionMobilityModel");
  mobility.Install (bsNodes.Get(0));

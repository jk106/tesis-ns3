...
(wifiStaNodes.Get(0) -> GetObject<ConstantVelocityMobilityModel>()) -> SetPosition(Vector(10.0, 0.0, 0.0)); 
(wifiStaNodes.Get(0) -> GetObject<ConstantVelocityMobilityModel>()) -> SetVelocity(Vector(20.0, 0.0, 0.0));
